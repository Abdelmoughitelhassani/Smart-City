...
# calcul movement increments
LATITUDE_INCREMENT = (BIRMINGHAM_COORDINATES["latitude"] - LONDON_COORDINATES["latitude"])/100
LONGITUDE_INCREMENT = (BIRMINGHAM_COORDINATES["longitude"] - LONDON_COORDINATES["longitude"])/100

# Environment variables for configuration
KAFKA_BOOTSTRAP_SERVERS = os.getenv('KAFKA_BOOTSTRAP_SERVERS', 'kafka:9092')
# KAFKA_BOOTSTRAP_SERVERS = os.getenv('KAFKA_BOOTSTRAP_SERVERS', '172.20.0.4:9092')
...
def generate_vehicle_data(device_id):
    location = simulate_vehicle_movment()
    return {
        'id': uuid.uuid4(),
        'deviceId': device_id,
...
if __name__ == "__main__":
    ...
    #     'security.protocol': 'PLAINTEXT',  # Ajoute cette ligne
    ...
    producer_config = {
        ...
        'value.serializer': lambda value, ctx: json.dumps(value, default=json_serializer).encode("utf-8")
    }
